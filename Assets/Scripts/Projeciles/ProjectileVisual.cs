...
public class ProjectileVisual : MonoBehaviour
{
    ...
    private Vector3 trajectoryStartPosition, targetPosition;
    ...
    private void Update() {
        ...
        float trajectoryMagnitude = (targetPosition - trajectoryStartPosition).magnitude;
    ...
    {
        projectileShadow.GetComponent<SpriteRenderer>().sprite = projectileSprite;
        projectileVisual.GetComponent<SpriteRenderer>().sprite = projectileSprite;
    }
}
